...
function jumplogin()
{
	if(authType==0)
		   ...
		   {
		   window.location.href = commonvar.serviceUrl.certificateLoginPage;
		   }
	   else if(authType==2)
		   {
		   window.location.href =commonvar.serviceUrl.certificateSSOLoginPage;
		   }
	   else if(authType==3)
		   {
		   window.location.href =commonvar.serviceUrl.miscellaneousLoginPage;
		   }
		else if(authType==4)
			{
		...
		{
			window.location.href =commonvar.serviceUrl.caLoginPage;
		}
		else if(authType==7)
		{
			window.location.href =commonvar.serviceUrl.cawstLoginPage;
		}
		else if(authType==6)
		{
			window.location.href =commonvar.serviceUrl.dynamicLoginPage;
		}
	   else
		   {
