...
function explicitSelfInit()
{
	...
	if (langType == "zh") {
		$("#notice").css("background","transparent url('/uns/darkblue/img/adch.png') no-repeat top center");
	}else{
		$("#notice").css("background","transparent url('/uns/darkblue/img/aden.png') no-repeat top center");
	}
...
function setItemInCookie(name, value) {
	...
	function changeLoginBtnColor(b) {
		if (!isSubmitted) {
			...
			if (b) {
				if (ff < 0) {
					buttonId.src = "/uns/darkblue/img/loginOver.gif";
				} else {
					buttonId.src = "/uns/darkblue/img/loginOver.png";
				}
			} else {
				if (ff < 0) {
					buttonId.src = "/uns/darkblue/img/login.gif";
				} else {
					buttonId.src = "/uns/darkblue/img/login.png";
				}
			}
		}
	}
