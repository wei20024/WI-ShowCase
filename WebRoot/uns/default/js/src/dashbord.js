...
=======
	// 在dom中添加虚拟机所需内容
	function appendHtmlForVm(type, isFistStaticGroup, eleId, vmName, isPool, inMaintenanceMode, vmVersion, platformKind) // 添加新vm所需的html内容，eleId为元素的Id值,vmName为vm的名字, isPool表示是否为池, 返回Dom内容的jquery对象
	{
		// 填充新桌面的HTML元素
		var templateSelector = "#vmTemplate";
		var containerSelector = "#vmList";
...
=======
	...
	webui.classspace.dashbord.Vm = function(inputPa) // 入参:{name:显示的名字, sid:sid, isActive:true|false, isPool:true|false, farmId:xxx,vmDomain:xxx, dgId:xxx, dgName: xxxx}
	{
		...
		instance.isPool = inputPa.isPool;
		instance.platformKind = inputPa.platformKind;
		instance.ele = appendHtmlForVm(inputPa.type, inputPa.isFistStaticGroup, vmId, inputPa.name, inputPa.isPool, inputPa.inMaintenanceMode, inputPa.vmVersion, inputPa.platformKind);
		instance.hdaVersion = inputPa.hdaVersion;
		instance.type = inputPa.type;
		instance.vmVersion = inputPa.vmVersion;
...
=======
	...
	function begin()
	{
		...
		getVmListTimmer = setInterval(tryLoop, webui.system.refreshVmStateTime);
...
=======
	...
	function begin(isExistVersion_R2, isExistVersion_R5)
	{
		...
		if (os == "Windows")
		{
			...
			$("#downloadClientButtion2_R21").attr("href", "/plugin/Clients/huaweiDesktop.exe");
		}
		else if (os == "Linux")
		{
		...
		if (os == "Linux") {
			if (r5ClientIsInstall != 1) {
				$("#downloadClientButtion2").text("");
				$("#downloadClientButtion2_R21").text("");
				$("#downloadClientButtion2_Net").text("");
			...
			if (r2ClientIsInstall == 1 && r5ClientIsInstall == 1 && r2NetIsInstall ==1) {
				...
				if (browser == "chrome")
				{
					$("#chromeDownloadText").text(LA("chrome download tip"));
					$("#chromedownloadClient_R21").attr("href", "/plugin/Clients/huaweiDesktop.exe");
					$("#chromedownloadClient_R21").text(LA("clickDownload"));
					$("#chromedownloadClient").text("");
					$("#chromedownloadClient_Net").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
					
					setTimeout(function(){
						$("#chromeDownloadTip").fadeIn();
					}, 1000);
					return;
				}
				else
				{
					$("#downloadClientButtion2_R21").text(LA("clickDownload"));
					$("#downloadClientButtion2").text("");
					$("#downloadClientButtion2_Net").text("");
					setTimeout(function(){
						dowloader.fadeIn();
				...
				{
					$("#chromeDownloadText").text(LA("chrome download tip"));
					$("#chromedownloadClient").attr("href", webui.system.windowsClientDownloadUrl);
					$("#chromedownloadClient").text(LA("clickDownload"));
					$("#chromedownloadClient_R21").text("");
					$("#chromedownloadClient_Net").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
				...
				else
				{
					$("#downloadClientButtion2_R21").text("");
					$("#downloadClientButtion2_Net").text("");
					$("#downloadClientButtion2").text(LA("clickDownload"));
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				}
				...
				{
					$("#chromeDownloadText").text(LA("chrome download tip"));
					$("#chromedownloadClient_Net").attr("href", "/plugin/Clients/connectTools.exe");
					$("#chromedownloadClient_Net").text(LA("clickDownload"));
					$("#chromedownloadClient_R21").text("");
					$("#chromedownloadClient").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
				...
				else
				{
					$("#downloadClientButtion2_R21").text("");
					$("#downloadClientButtion2").text("");
					$("#downloadClientButtion2_Net").text(LA("clickDownload"));
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				}
				...
				if (browser == "chrome")
				{
					$("#chromeDownloadText").text(LA("chrome download tip"));
					$("#chromedownloadClient_R21").attr("href", "/plugin/Clients/huaweiDesktop.exe");
					$("#chromedownloadClient_R21").text(LA("clickDownload1"));
					$("#chromedownloadClient").attr("href", webui.system.windowsClientDownloadUrl);
					$("#chromedownloadClient").text(LA("clickDownload2"));
					$("#chromedownloadClient_Net").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
				...
				{
					$("#downloadClientButtion2_R21").text(LA("clickDownload1"));
					$("#downloadClientButtion2").text(LA("clickDownload2"));
					$("#downloadClientButtion2_Net").text("");
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				...
				if (browser == "chrome")
				{
					...
					$("#chromedownloadClient_R21").text(LA("clickDownload1"));
					$("#chromedownloadClient_Net").attr("href", "/plugin/Clients/connectTools.exe");
					$("#chromedownloadClient_Net").text(LA("clickDownload2"));
					$("#chromedownloadClient").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
				...
				else
				{
					$("#downloadClientButtion2_R21").text(LA("clickDownload1"));
					$("#downloadClientButtion2").text("");
					$("#downloadClientButtion2_Net").text(LA("clickDownload2"));
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				}
				...
				if (browser == "chrome")
				{
					$("#chromeDownloadText").text(LA("chrome download tip"));
					$("#chromedownloadClient").attr("href", webui.system.windowsClientDownloadUrl);
					$("#chromedownloadClient").text(LA("clickDownload1"));
					$("#chromedownloadClient_Net").attr("href", "/plugin/Clients/connectTools.exe");
					$("#chromedownloadClient_Net").text(LA("clickDownload2"));
					$("#chromedownloadClient_R21").text("");
					$("#chromeDownloadRefTip").text(LA("Download Client"));
				...
				{
					$("#downloadClientButtion2_R21").text("");
					$("#downloadClientButtion2").text(LA("clickDownload1"));
					$("#downloadClientButtion2_Net").text(LA("clickDownload2"));
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				...
				else
				{
					$("#downloadClientButtion2_R21").text(LA("clickDownload1"));
					$("#downloadClientButtion2").text(LA("clickDownload2"));
					$("#downloadClientButtion2_Net").text(LA("clickDownload3"));
					setTimeout(function(){
						dowloader.fadeIn();
					}, 2000);
				}
...
=======
	...
	function show()
	{
		// 读取当前cookie存储的背景
		var cookieImg = $.cookie("bgImg");
		var optionVal = "/webui/default/img/null.jpg";
		if (cookieImg != null) optionVal = cookieImg;
		$("#changeBg").find(".bgSelector").val(optionVal);
		$("#changeBg").find(".bgPreview").attr("src", $("#changeBg").find(".bgSelector").val());
...
=======
	...
	function begin()
	{
		...
		$(window).focus(function() {	
			...
			webuilog(loglevel.info,"start getVmListTimmer ");
			webui.objects.dashbord.vmMgr.tryLoop();
			getVmListTimmer = setInterval(webui.objects.dashbord.vmMgr.tryLoop, webui.system.refreshVmStateTime);
		});
