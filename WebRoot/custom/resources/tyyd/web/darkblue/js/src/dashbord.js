...
(function(){
	...
	function appendHtmlForVm(type, isFistStaticGroup, eleId, vmName, isPool, inMaintenanceMode, vmVersion, groupName) // 添加新vm所需的html内容，eleId为元素的Id值,vmName为vm的名字, isPool表示是否为池, 返回Dom内容的jquery对象
	{
		...
		if (vmVersion == "R21") {
			...
			var r5content = '<li style="overflow: hidden; float: left; width: 245px; height: 111px;">'+
							...
							'			<div style="background-image: url(&quot;/custom/resources/tyyd/web/darkblue/img/comp_2.png&quot;);"'+
							...
							'						src="/custom/resources/tyyd/web/darkblue/img/Transparent32.gif" >'+
							'				</div>'+
							'			</div>'+ 
							'		</a>'+
							'	</div>'+
    ...
    function connectVmNormal_R21(instance, inputPa)
    {
    	...
    	setLoadingImg("spinner_"+instance.ele.attr("id"), "/custom/resources/tyyd/web/darkblue/img/Loader.gif");
    ...
    function queryVmState(instance)
	{
		...
		if (new Date().getTime() - queryVmStateBeginTime > webui.system.connectVmTimeout) {
    		...
    		setLoadingImg("spinner_"+instance.ele.attr("id"), "/custom/resources/tyyd/web/darkblue/img/Transparent32.gif");
		}else{
			$.ajax({
...
(function(){
	...
	function begin()
	{
		...
		// 翻译按钮语言
		$("#messageBox").find(".globalDialogOkLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmOkLinkuns") + ".png)");
		$("#messageBox").find(".globalDialogCanncelLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmCanncelLinkuns") + ".png)");
		$("#messageBox").find(".globalDialogIgnoreLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmIgnoreLinkuns") + ".png)");
	}
...
(function(){
	...
	function begin()
	{
		...
		// 翻译按钮语言
		$("#choiceLang").find(".globalDialogOkLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmOkLinkuns") + ".png)");
		$("#choiceLang").find(".globalDialogCanncelLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmCanncelLinkuns") + ".png)");
	}
...
(function(){
	...
	function show()
	{
		...
		var optionVal = "/custom/resources/tyyd/web/darkblue/img/backGroundMainE.jpg";
	...
	function begin()
	{
		...
		// 翻译按钮语言
		$("#changeBg").find(".globalDialogOkLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmOkLinkuns") + ".png)");
		$("#changeBg").find(".globalDialogCanncelLink").css("background-image", "url(/custom/resources/tyyd/web/darkblue/img/dashbord/" + LA("globalConfirmCanncelLinkuns") + ".png)");
