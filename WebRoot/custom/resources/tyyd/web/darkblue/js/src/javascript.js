...
function setSpinnerVisible(appId, show) {
    ...
    if (eltApp) {
        eltApp.src = (show) ? "/custom/resources/tyyd/web/darkblue/img/Loader.gif" : "/custom/resources/tyyd/web/darkblue/img/Transparent32.gif";
    }
    else
    {
        if(show){
...
function isHighContrastEnabled() {
    ...
    testDiv.style.background = "url(/custom/resources/tyyd/web/darkblue/img/Error24.gif)";
...
function updateDesktopIcon(desktopId, isActive) {
    ...
    if (screenElt) {
       screenElt.style.backgroundImage = "url(/custom/resources/tyyd/web/darkblue/img/comp_2.png)"; 
    }
}
...
function setLaunchReadyIcon(doc, desktopId) {
    ...
    if (spinnerNode) {
        spinnerNode.src = "/custom/resources/tyyd/web/darkblue/img/LaunchReady.gif";
    }
    ...
    for (var j = 0; j <currentNode.childNodes.length; j++) {
        ...
        if (imgChildNode.nodeName == "IMG") {
            if (isMouseHover) {
               ...
               imgChildNode.src="/custom/resources/tyyd/web/darkblue/img/ActiveClose.gif";
            } else {
...
function saveBackGround()
{
    ...
    for(var i=0;i<radios.length;i++)
    {
        if(radios[i].checked)
        {
            ...
            $.cookie("darkblue_bgImg", "/custom/resources/tyyd/web/darkblue/img/" + radios[i].value + ".jpg", {expires:365,path:'/'});}
        }
    }
...
function switchBackground()
{
    ...
    if(newBack == "" )
    {
        if(tmpWindow <= 768)
        {
            document.body.style.background = "url('/custom/resources/tyyd/web/darkblue/img/backGroundMainE2.jpg') no-repeat scroll center top #21356A";
        }
        else
        {
            
            document.body.style.background = "url('/custom/resources/tyyd/web/darkblue/img/backGroundMainE.jpg') no-repeat scroll center top #21356A";
        }
    }
    else
    {
        if(tmpWindow <= 768)
        {
            document.body.style.background = "url('/custom/resources/tyyd/web/darkblue/img/" + newBack + "2.jpg') no-repeat scroll center top #21356A";
        }
        else
        {
            document.body.style.background = "url('/custom/resources/tyyd/web/darkblue/img/" + newBack + ".jpg') no-repeat scroll center top #21356A";
        }
     }
}
...
{
    if ("url(/custom/resources/tyyd/web/darkblue/img/comp_2.png)" == ele.style.backgroundImage || "url(/custom/resources/tyyd/web/darkblue/img/comp_2over.png)" == ele.style.backgroundImage
        || 'url("/custom/resources/tyyd/web/darkblue/img/comp_2.png")' == ele.style.backgroundImage || 'url("/custom/resources/tyyd/web/darkblue/img/comp_2over.png")' == ele.style.backgroundImage)
    {
          ele.style.backgroundImage = "url(/custom/resources/tyyd/web/darkblue/img/comp_2over.png)"; 
    }
    else
    {
        ele.style.backgroundImage = "url(/custom/resources/tyyd/web/darkblue/img/comp_2over.png)"; 
...
{ 
    if ("url(/custom/resources/tyyd/web/darkblue/img/comp_2.png)" == ele.style.backgroundImage || "url(/custom/resources/tyyd/web/darkblue/img/comp_2over.png)" == ele.style.backgroundImage
       ||'url("/custom/resources/tyyd/web/darkblue/img/comp_2.png")' == ele.style.backgroundImage || 'url("/custom/resources/tyyd/web/darkblue/img/comp_2over.png")' == ele.style.backgroundImage)
    {
        ele.style.backgroundImage = "url(/custom/resources/tyyd/web/darkblue/img/comp_2.png)"; 
    } 
    else
    {
        ele.style.backgroundImage = "url(/custom/resources/tyyd/web/darkblue/img/comp_2.png)";
...
if(isin == true)
{
   obj.style.background = "url(/custom/resources/tyyd/web/darkblue/img/mid_bg.png) no-repeat";
