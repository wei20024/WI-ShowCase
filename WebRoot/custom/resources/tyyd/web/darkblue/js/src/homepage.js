...
function openFolder(node) {
	...
	changeSrcOfChildImgNodes(node, "/custom/resources/tyyd/web/darkblue/img/FolderOpenArrowDown.gif");
}

function closeFolder(node) {
	node.className = "folderClose";
	node.nextSibling.style.display = 'none';
	changeSrcOfChildImgNodes(node, "/custom/resources/tyyd/web/darkblue/img/FolderClosedArrow.gif");
}

function updateMouseoverTreeNodePicture(node) {
	var nodeClass = node.className;
	if (nodeClass == "folderClose") {
		changeSrcOfChildImgNodes(node, "/custom/resources/tyyd/web/darkblue/img/FolderClosedArrowHover.gif");
	} else {
		changeSrcOfChildImgNodes(node, "/custom/resources/tyyd/web/darkblue/img/FolderOpenArrowDownHover.gif");
	}
}
