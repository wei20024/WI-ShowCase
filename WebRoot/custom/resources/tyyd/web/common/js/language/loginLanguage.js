...
Login.loginLanguage = { // 登录界面字符串
		zh:{
			...
			'changeFgPass':"更改密码",
			'openFg':"点击指纹登陆",
			'confirmbtn':"url(/custom/resources/tyyd/web/default/img/btnyes.png)",
			'cancelbtn':"url(/custom/resources/tyyd/web/default/img/btnno.png)",
			'loginbtn':"url(/custom/resources/tyyd/web/default/img/loginzh.png)",
			'adimg':"/custom/resources/tyyd/web/default/img/adch.png",
		...
		'resetPwdSuccess':"重置密码成功,请查收短信",
		'resetPwdFaild':"重置密码成功失败",
		'ResultCode.code.CALL_PLATFORM_FAIL':'调用认证系统失败'
		},
		en:{
			...
			'confirmbtn':"url(/custom/resources/tyyd/web/default/img/btnok.png)",
			'cancelbtn':"url(/custom/resources/tyyd/web/default/img/btncancel.png)",
			'loginbtn':"url(/custom/resources/tyyd/web/default/img/loginen.png)",
			'adimg':"/custom/resources/tyyd/web/default/img/aden.png",
		...
		/* 9XX APP ERROR CODE*/
			...
			'resetPwdFaild':"reset password failed",
			'ResultCode.code.CALL_PLATFORM_FAIL':'Call the authentication system failed'
		},
		ar:{
			...
			'confirmbtn':"url(/custom/resources/tyyd/web/arabic/img/btnokar.png)",
			'cancelbtn':"url(/custom/resources/tyyd/web/arabic/img/btncancelar.png)",
			'loginbtn':"url(/custom/resources/tyyd/web/arabic/img/loginar.png)",
			'adimg':"/custom/resources/tyyd/web/default/img/aden.png",
