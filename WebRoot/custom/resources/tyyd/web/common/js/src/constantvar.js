...
var commonvar={
	...
	loadcss:function(file)
	{
		...
		{	
			file = "/custom/resources/tyyd/web/default/css/arabic/" + file;
		}
		else
		{
...
(function(){
	...
	function show()
	{
		...
		$("#choiceLang").find(".langSelectors").val(optionVal);
	...
	{
		$("#choiceLang").hide();
		var optionVal = $("#choiceLang").find(".langSelectors").val();
		if (result == "<Ok>")
		{
	...
	{
		// 绑定行为
		$("#choiceLang").find(".langDialogClose").click(function(){hide("<Canncel>")});
		$("#choiceLang").find(".langDialogOkLink").click(function(){hide("<Ok>")});
		$("#choiceLang").find(".langDialogCanncelLink").click(function(){hide("<Canncel>")});
	}
	
	commonvar.LangChoice = 
	{
		begin: begin,
		show: show
	};
