...
webui.system.bgImg="/custom/resources/tyyd/web/default/img/null.jpg";
...
webui.system.desktopList=[];
	...
	//mac客户端最低版本
	webui.system.macClientVersion = '1.5.30.0';
	...
	webui.system.unknowAccessDownloadUrl = '/custom/resources/tyyd/web/common/pages/download.html';
	webui.system.linuxClientDownloadUrl = 'LinuxClientSetupX86.bin';
...
webui.system.config={
		...
		androidTcClientVersion:'1.5.10010', //androidTc移动客户端最低版本
