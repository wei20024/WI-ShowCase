...
<!-- 模板,公共js、logo、css样式 -->
	    ...
	    <script type="text/javascript" src="/custom/resources/tyyd/web/default/js/src/changepassword.js"></script>	

		<div id="passExpired" style="display:none;">
			<img id="alertBg" src="/custom/resources/tyyd/web/default/img/smallframe.png">	
			<label id="alertTitle"></label>		
			<img id="alertIcon" src="/custom/resources/tyyd/web/default/img/error.png">
		...
		<div id="modifyPasswordDiv" style="display:none;">
			<img id="modBg" src="/custom/resources/tyyd/web/default/img/largeframe.png">
			<label id="modTitle">修改密码</label>
			<div id="modifyInputDiv" class="modifyClass">				
				<div id="errorModifyDiv">
					<img id="errorDivImg" src="/custom/resources/tyyd/web/default/img/bubbleerror.png">
			...
			<div id="modifySuccessDiv" class="modifyClass">
				<img id="successImg" src="/custom/resources/tyyd/web/default/img/successicon.png">
			...
			<div id="loadingpanel">
    			<img src="/custom/resources/tyyd/web/default/img/Loader.gif">
   			 </div>
		</div>
