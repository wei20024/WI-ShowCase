...
(function(){
    ...
    function appendHtmlForVm(type, isFistStaticGroup, eleId, vmName, isPool, inMaintenanceMode, vmVersion, platformKind, instance) // 添加新vm所需的html内容，eleId为元素的Id值,vmName为vm的名字, isPool表示是否为池, 返回Dom内容的jquery对象
    {
        ...
        if (vmVersion == "R51") {
            ...
            if (platformKind == 2)
            {
                ele.find(".loginVnc").hide();
                ele.find(".powerSet").hide();
                ele.find(".vmOptionPannel").css({"background-image":"url(/custom/resources/tyyd/web/default/img/dashbord/vmOptionPannelMid.png)","width":"69px"});
            ...
            else if (platformKind > 0)
            {
                ...
                ele.find(".forceReboot").hide();
                ele.find(".powerSet").hide();
                ele.find(".vmOptionPannel").css({"background-image":"url(/custom/resources/tyyd/web/default/img/dashbord/vmOptionTiny.png)","width":"65px"});
    ...
    function callVNCClient(instance, loginInfo, isAutoVncLogin)
    {
        ...
        if ($.cookie("vnctip") != 0)
        {
            ...
            $("#globalDialog").css("background-image", "url(/custom/resources/tyyd/web/default/img/dashbord/midbox.png)"); 
            ...
            webui.objects.dashbord.messageBox.show(LA("Notice"), LA("Vnc Tip:"), "<Ok><Canncel>", function(result){
                ...
                $("#globalDialog").css("background-image", "url(/custom/resources/tyyd/web/default/img/dashbord/smallbox.png)"); 
...
(function(){
    ...
    function changeBoxStyle(clientDownloadUrl){
        $("#messageBox").find(".globalDialog").css({
            "background-image": "url(/custom/resources/tyyd/web/default/img/dashbord/midbox_2.png)"
        });
...
(function(){
    ...
    function show()
    {
        ...
        var optionVal = "/custom/resources/tyyd/web/default/img/null.jpg";
